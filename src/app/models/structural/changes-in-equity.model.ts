export interface StructuralChangesInEquityListItem {
  id: string;
  isin: string;
  symbol: string;
  traceNo: number;
...
export interface StructuralChangesInEquityItem {
  rowCode: number;
  rowType: string | null;
...
export interface StructuralChangesInEquityDetail {
  id: string;
  isin: string;
  symbol: string;
  uri: string;
  ...
  createdAt: string;
  updatedAt: string;
  items: StructuralChangesInEquityItem[];
}
