export interface BankChangesInEquityListItem {
  id: string;
  isin: string;
  symbol: string;
  traceNo: number;
...
export interface BankChangesInEquityItem {
  rowCode: number;
  rowType: string | null;
...
export interface BankChangesInEquityDetail {
  id: string;
  isin: string;
  symbol: string;
  uri: string;
