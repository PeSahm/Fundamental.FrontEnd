export interface LeasingChangesInEquityListItem {
  id: string;
  isin: string;
  symbol: string;
  traceNo: number;
...
export interface LeasingChangesInEquityItem {
  rowCode: number;
  rowType: string | null;
...
export interface LeasingChangesInEquityDetail {
  id: string;
  isin: string;
  symbol: string;
  uri: string;
  ...
  createdAt: string;
  updatedAt: string;
  items: LeasingChangesInEquityItem[];
}
