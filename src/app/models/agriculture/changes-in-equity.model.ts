export interface AgricultureChangesInEquityListItem {
  id: string;
  isin: string;
  symbol: string;
  traceNo: number;
...
export interface AgricultureChangesInEquityItem {
  rowCode: number;
  rowType: string | null;
...
export interface AgricultureChangesInEquityDetail {
  id: string;
  isin: string;
  symbol: string;
  uri: string;
  ...
  createdAt: string;
  updatedAt: string;
  items: AgricultureChangesInEquityItem[];
}
