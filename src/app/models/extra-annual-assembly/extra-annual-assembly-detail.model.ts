import { AssemblyInterim, AssemblyAttendee, AssemblyBoardMember, BoardMemberWageAndGift, Inspector, NewsPaper, NewBoardMember, ProportionedRetainedEarning, SessionOrder, ShareHolder } from '../annual-assembly/models';
import { AssemblyResultType } from '../annual-assembly/types';

export interface ExtraAnnualAssemblyDetail {
  id: string;
  isin: string;
  symbol: string;
  title: string;
