...
describe('AgricultureIncomeStatementListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<AgricultureIncomeStatementService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'is-1', symbol: 'وسینا', isin: 'IRO1SINA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 7, uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  const mockDetailResponse = {
    data: {
      details: [
        ...
        { row: 2, codalRow: 201, description: 'هزینه‌های عملیاتی', value: 5000000 },
      ]
    }
  };

  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('AgricultureIncomeStatementService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: AgricultureIncomeStatementService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'is-1', symbol: 'وسینا', isin: 'IRO1SINA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 7, uri: 'https://codal.ir/1' };
