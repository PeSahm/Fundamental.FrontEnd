...
export class AgricultureIncomeStatementListComponent implements OnInit, OnDestroy {
  ...
  constructor(private service: AgricultureIncomeStatementService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/agriculture/income-statement', rowItem.id]); } }
