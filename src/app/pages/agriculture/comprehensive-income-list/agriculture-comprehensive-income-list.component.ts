...
interface AgricultureComprehensiveIncomeItem {
  id: string;
  symbol: string;
  isin: string;
  fiscalYear: number;
...
interface AgricultureComprehensiveIncomeDetailItem {
  row: number;
  codalRow: number;
  description: string;
  value: number | null;
...
export class AgricultureComprehensiveIncomeListComponent implements OnInit, OnDestroy {
  ...
  totalRecords = 0;
  reports: AgricultureComprehensiveIncomeItem[] | null = null;
  children: AgricultureComprehensiveIncomeDetailItem[] | null = null;
  isLoading = true;
  ...
  constructor(private service: AgricultureComprehensiveIncomeService) { }
  ...
  getDetailRow(row: DetailRow<AgricultureComprehensiveIncomeItem>): void {
    if (row.expand) {
