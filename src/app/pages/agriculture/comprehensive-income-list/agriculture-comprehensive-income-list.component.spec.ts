...
describe('AgricultureComprehensiveIncomeListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<AgricultureComprehensiveIncomeService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'ci-1', symbol: 'وسینا', isin: 'IRO1SINA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('AgricultureComprehensiveIncomeService', ['getAll', 'getById']);
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'ci-1', symbol: 'وسینا', isin: 'IRO1SINA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', uri: 'https://codal.ir/1' };
