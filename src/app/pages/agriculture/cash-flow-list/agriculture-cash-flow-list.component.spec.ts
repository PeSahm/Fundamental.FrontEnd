...
describe('AgricultureCashFlowListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<AgricultureCashFlowService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'cf-1', symbol: 'وسینا', isin: 'IRO1SINA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 5, uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  const mockDetailResponse = {
    data: {
      details: [
        { row: 1, codalRow: 300, description: 'جریان نقدی عملیاتی', value: 3000000 },
        { row: 2, codalRow: 301, description: 'جریان نقدی سرمایه‌گذاری', value: -1000000 },
      ]
    }
  };

  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('AgricultureCashFlowService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: AgricultureCashFlowService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'cf-1', symbol: 'وسینا', isin: 'IRO1SINA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 5, uri: 'https://codal.ir/1' };
