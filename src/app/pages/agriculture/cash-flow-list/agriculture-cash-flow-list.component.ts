...
export class AgricultureCashFlowListComponent implements OnInit, OnDestroy {
  ...
  constructor(private service: AgricultureCashFlowService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/agriculture/cash-flow', rowItem.id]); } }
