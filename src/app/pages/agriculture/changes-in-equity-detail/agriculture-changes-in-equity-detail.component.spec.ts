...
import { AgricultureChangesInEquityDetailComponent } from './agriculture-changes-in-equity-detail.component';
...
describe('AgricultureChangesInEquityDetailComponent', () => {
  let component: AgricultureChangesInEquityDetailComponent;
  let fixture: ComponentFixture<AgricultureChangesInEquityDetailComponent>;
  let mockService: jasmine.SpyObj<AgricultureChangesInEquityService>;
  ...
  beforeEach(async () => {
    const serviceSpy = jasmine.createSpyObj('AgricultureChangesInEquityService', ['getById']);
    ...
    await TestBed.configureTestingModule({
      declarations: [AgricultureChangesInEquityDetailComponent, PersianNumberPipe, JalaliDatePipe],
      imports: [RouterTestingModule, NgbTooltipModule],
      providers: [
        { provide: AgricultureChangesInEquityService, useValue: serviceSpy },
        { provide: ActivatedRoute, useValue: activatedRouteSpy }
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(AgricultureChangesInEquityDetailComponent);
    component = fixture.componentInstance;
    mockService = TestBed.inject(AgricultureChangesInEquityService) as jasmine.SpyObj<AgricultureChangesInEquityService>;
