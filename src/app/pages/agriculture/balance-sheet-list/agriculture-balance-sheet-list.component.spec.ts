...
describe('AgricultureBalanceSheetListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<AgricultureBalanceSheetService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'bs-1', symbol: 'وسینا', isin: 'IRO1SINA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 5, uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('AgricultureBalanceSheetService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: AgricultureBalanceSheetService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'bs-1', symbol: 'وسینا', isin: 'IRO1SINA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 5, uri: 'https://codal.ir/1' };
