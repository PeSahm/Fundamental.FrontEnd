...
import { of } from 'rxjs';
import { BankIncomeStatementListComponent } from './bank-income-statement-list.component';
import { BankIncomeStatementService } from 'src/app/services/bank-income-statement.service';
...
describe('BankIncomeStatementListComponent', () => {
  let component: BankIncomeStatementListComponent;
  let fixture: ComponentFixture<BankIncomeStatementListComponent>;
  let serviceSpy: jasmine.SpyObj<BankIncomeStatementService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('BankIncomeStatementService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: BankIncomeStatementService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(BankIncomeStatementListComponent);
