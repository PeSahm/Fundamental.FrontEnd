...
import { of } from 'rxjs';
import { BankCashFlowListComponent } from './bank-cash-flow-list.component';
import { BankCashFlowService } from 'src/app/services/bank-cash-flow.service';
...
describe('BankCashFlowListComponent', () => {
  let component: BankCashFlowListComponent;
  let fixture: ComponentFixture<BankCashFlowListComponent>;
  let serviceSpy: jasmine.SpyObj<BankCashFlowService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('BankCashFlowService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: BankCashFlowService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(BankCashFlowListComponent);
