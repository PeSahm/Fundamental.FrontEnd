...
import { of } from 'rxjs';
import { BankComprehensiveIncomeListComponent } from './bank-comprehensive-income-list.component';
...
describe('BankComprehensiveIncomeListComponent', () => {
  let component: BankComprehensiveIncomeListComponent;
  let fixture: ComponentFixture<BankComprehensiveIncomeListComponent>;
  let serviceSpy: jasmine.SpyObj<BankComprehensiveIncomeService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('BankComprehensiveIncomeService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: BankComprehensiveIncomeService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(BankComprehensiveIncomeListComponent);
