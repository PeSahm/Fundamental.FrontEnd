...
import { BankChangesInEquityDetailComponent } from './bank-changes-in-equity-detail.component';
...
describe('BankChangesInEquityDetailComponent', () => {
  let component: BankChangesInEquityDetailComponent;
  let fixture: ComponentFixture<BankChangesInEquityDetailComponent>;
  let mockService: jasmine.SpyObj<BankChangesInEquityService>;
  ...
  beforeEach(async () => {
    const serviceSpy = jasmine.createSpyObj('BankChangesInEquityService', ['getById']);
    ...
    await TestBed.configureTestingModule({
      declarations: [BankChangesInEquityDetailComponent, PersianNumberPipe, JalaliDatePipe],
      imports: [RouterTestingModule, NgbTooltipModule],
      providers: [
        { provide: BankChangesInEquityService, useValue: serviceSpy },
        { provide: ActivatedRoute, useValue: activatedRouteSpy }
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(BankChangesInEquityDetailComponent);
    component = fixture.componentInstance;
    mockService = TestBed.inject(BankChangesInEquityService) as jasmine.SpyObj<BankChangesInEquityService>;
