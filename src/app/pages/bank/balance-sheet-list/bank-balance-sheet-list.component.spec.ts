...
import { of } from 'rxjs';
import { BankBalanceSheetListComponent } from './bank-balance-sheet-list.component';
...
describe('BankBalanceSheetListComponent', () => {
  let component: BankBalanceSheetListComponent;
  let fixture: ComponentFixture<BankBalanceSheetListComponent>;
  let serviceSpy: jasmine.SpyObj<BankBalanceSheetService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('BankBalanceSheetService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: BankBalanceSheetService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(BankBalanceSheetListComponent);
