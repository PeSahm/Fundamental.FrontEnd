...
describe('InvestmentBalanceSheetListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<InvestmentBalanceSheetService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'bs-1', symbol: 'وتجارت', isin: 'IRO7TEJA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 5, uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('InvestmentBalanceSheetService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: InvestmentBalanceSheetService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'bs-1', symbol: 'وتجارت', isin: 'IRO7TEJA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 5, uri: 'https://codal.ir/1' };
