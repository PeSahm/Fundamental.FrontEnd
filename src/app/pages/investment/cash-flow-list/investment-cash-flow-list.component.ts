...
export class InvestmentCashFlowListComponent implements OnInit, OnDestroy {
  ...
  constructor(private service: InvestmentCashFlowService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/investment/cash-flow', rowItem.id]); } }
