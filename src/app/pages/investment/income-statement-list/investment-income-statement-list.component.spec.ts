...
describe('InvestmentIncomeStatementListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<InvestmentIncomeStatementService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'is-1', symbol: 'وتجارت', isin: 'IRO7TEJA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 7, uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  const mockDetailResponse = {
    data: {
      details: [
        ...
        { row: 2, codalRow: 201, description: 'هزینه‌های عملیاتی', value: 3000000 },
      ]
    }
  };

  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('InvestmentIncomeStatementService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: InvestmentIncomeStatementService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'is-1', symbol: 'وتجارت', isin: 'IRO7TEJA0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 7, uri: 'https://codal.ir/1' };
