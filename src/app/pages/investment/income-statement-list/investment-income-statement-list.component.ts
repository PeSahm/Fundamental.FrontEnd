...
export class InvestmentIncomeStatementListComponent implements OnInit, OnDestroy {
  ...
  constructor(private service: InvestmentIncomeStatementService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/investment/income-statement', rowItem.id]); } }
