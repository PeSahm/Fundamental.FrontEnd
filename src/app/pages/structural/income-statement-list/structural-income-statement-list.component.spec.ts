...
describe('StructuralIncomeStatementListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<StructuralIncomeStatementService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('StructuralIncomeStatementService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: StructuralIncomeStatementService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();
