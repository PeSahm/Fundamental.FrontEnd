...
export class StructuralIncomeStatementListComponent implements OnInit, OnDestroy {
  ...
  constructor(private service: StructuralIncomeStatementService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/structural/income-statement', rowItem.id]); } }
