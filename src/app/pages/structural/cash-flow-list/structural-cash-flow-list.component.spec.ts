...
describe('StructuralCashFlowListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<StructuralCashFlowService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('StructuralCashFlowService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: StructuralCashFlowService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();
