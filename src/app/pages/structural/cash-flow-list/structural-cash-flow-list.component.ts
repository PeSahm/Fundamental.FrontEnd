...
export class StructuralCashFlowListComponent implements OnInit, OnDestroy {
  ...
  constructor(private service: StructuralCashFlowService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/structural/cash-flow', rowItem.id]); } }
