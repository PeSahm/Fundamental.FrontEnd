...
export class StructuralBalanceSheetListComponent implements OnInit, OnDestroy {
  ...
  constructor(private service: StructuralBalanceSheetService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/structural/balance-sheet', rowItem.id]); } }
