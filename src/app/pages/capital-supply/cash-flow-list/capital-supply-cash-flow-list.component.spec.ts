...
import { of } from 'rxjs';
import { CapitalSupplyCashFlowListComponent } from './capital-supply-cash-flow-list.component';
import { CapitalSupplyCashFlowService } from 'src/app/services/capital-supply-cash-flow.service';
...
describe('CapitalSupplyCashFlowListComponent', () => {
  let component: CapitalSupplyCashFlowListComponent;
  let fixture: ComponentFixture<CapitalSupplyCashFlowListComponent>;
  let serviceSpy: jasmine.SpyObj<CapitalSupplyCashFlowService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'cf-1', symbol: 'وساخت', isin: 'IRO1VSKT0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 3, uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  const mockDetailResponse = {
    data: {
      details: [
        { row: 1, codalRow: 300, description: 'جریان نقد عملیاتی', value: 6000000 },
        { row: 2, codalRow: 301, description: 'جریان نقد سرمایه‌گذاری', value: -2000000 },
      ]
    }
  };

  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('CapitalSupplyCashFlowService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: CapitalSupplyCashFlowService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(CapitalSupplyCashFlowListComponent);
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'cf-1', symbol: 'وساخت', isin: 'IRO1VSKT0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 3, uri: 'https://codal.ir/1' };
