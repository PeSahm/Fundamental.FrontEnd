...
import { of } from 'rxjs';
import { CapitalSupplyComprehensiveIncomeListComponent } from './capital-supply-comprehensive-income-list.component';
...
describe('CapitalSupplyComprehensiveIncomeListComponent', () => {
  let component: CapitalSupplyComprehensiveIncomeListComponent;
  let fixture: ComponentFixture<CapitalSupplyComprehensiveIncomeListComponent>;
  let serviceSpy: jasmine.SpyObj<CapitalSupplyComprehensiveIncomeService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('CapitalSupplyComprehensiveIncomeService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: CapitalSupplyComprehensiveIncomeService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(CapitalSupplyComprehensiveIncomeListComponent);
