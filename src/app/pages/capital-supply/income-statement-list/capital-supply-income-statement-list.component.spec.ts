...
import { of } from 'rxjs';
import { CapitalSupplyIncomeStatementListComponent } from './capital-supply-income-statement-list.component';
import { CapitalSupplyIncomeStatementService } from 'src/app/services/capital-supply-income-statement.service';
...
describe('CapitalSupplyIncomeStatementListComponent', () => {
  let component: CapitalSupplyIncomeStatementListComponent;
  let fixture: ComponentFixture<CapitalSupplyIncomeStatementListComponent>;
  let serviceSpy: jasmine.SpyObj<CapitalSupplyIncomeStatementService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'is-1', symbol: 'وساخت', isin: 'IRO1VSKT0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 3, uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  const mockDetailResponse = {
    data: {
      details: [
        { row: 1, codalRow: 200, description: 'درآمدهای عملیاتی', value: 8000000 },
        { row: 2, codalRow: 201, description: 'بهای تمام‌شده', value: 3500000 },
      ]
    }
  };

  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('CapitalSupplyIncomeStatementService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: CapitalSupplyIncomeStatementService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(CapitalSupplyIncomeStatementListComponent);
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'is-1', symbol: 'وساخت', isin: 'IRO1VSKT0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 3, uri: 'https://codal.ir/1' };
    component.getDetailRow({ expand: true, rowData: fakeRow });
    expect(serviceSpy.getById).toHaveBeenCalledWith('is-1');
