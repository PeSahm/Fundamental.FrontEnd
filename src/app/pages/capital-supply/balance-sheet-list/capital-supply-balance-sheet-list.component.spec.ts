...
import { of } from 'rxjs';
import { CapitalSupplyBalanceSheetListComponent } from './capital-supply-balance-sheet-list.component';
...
describe('CapitalSupplyBalanceSheetListComponent', () => {
  let component: CapitalSupplyBalanceSheetListComponent;
  let fixture: ComponentFixture<CapitalSupplyBalanceSheetListComponent>;
  let serviceSpy: jasmine.SpyObj<CapitalSupplyBalanceSheetService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('CapitalSupplyBalanceSheetService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: CapitalSupplyBalanceSheetService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(CapitalSupplyBalanceSheetListComponent);
