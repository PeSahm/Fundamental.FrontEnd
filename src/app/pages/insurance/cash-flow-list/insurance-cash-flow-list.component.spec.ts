...
import { of } from 'rxjs';
import { InsuranceCashFlowListComponent } from './insurance-cash-flow-list.component';
import { InsuranceCashFlowService } from 'src/app/services/insurance-cash-flow.service';
...
describe('InsuranceCashFlowListComponent', () => {
  let component: InsuranceCashFlowListComponent;
  let fixture: ComponentFixture<InsuranceCashFlowListComponent>;
  let serviceSpy: jasmine.SpyObj<InsuranceCashFlowService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('InsuranceCashFlowService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: InsuranceCashFlowService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(InsuranceCashFlowListComponent);
