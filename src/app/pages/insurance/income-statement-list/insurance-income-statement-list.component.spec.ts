...
import { of } from 'rxjs';
import { InsuranceIncomeStatementListComponent } from './insurance-income-statement-list.component';
import { InsuranceIncomeStatementService } from 'src/app/services/insurance-income-statement.service';
...
describe('InsuranceIncomeStatementListComponent', () => {
  let component: InsuranceIncomeStatementListComponent;
  let fixture: ComponentFixture<InsuranceIncomeStatementListComponent>;
  let serviceSpy: jasmine.SpyObj<InsuranceIncomeStatementService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('InsuranceIncomeStatementService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: InsuranceIncomeStatementService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(InsuranceIncomeStatementListComponent);
