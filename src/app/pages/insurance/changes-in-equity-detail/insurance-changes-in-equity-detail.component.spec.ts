...
import { InsuranceChangesInEquityDetailComponent } from './insurance-changes-in-equity-detail.component';
...
describe('InsuranceChangesInEquityDetailComponent', () => {
  let component: InsuranceChangesInEquityDetailComponent;
  let fixture: ComponentFixture<InsuranceChangesInEquityDetailComponent>;
  let mockService: jasmine.SpyObj<InsuranceChangesInEquityService>;
  ...
  beforeEach(async () => {
    const serviceSpy = jasmine.createSpyObj('InsuranceChangesInEquityService', ['getById']);
    ...
    await TestBed.configureTestingModule({
      declarations: [InsuranceChangesInEquityDetailComponent, PersianNumberPipe, JalaliDatePipe],
      imports: [RouterTestingModule, NgbTooltipModule],
      providers: [
        { provide: InsuranceChangesInEquityService, useValue: serviceSpy },
        { provide: ActivatedRoute, useValue: activatedRouteSpy }
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(InsuranceChangesInEquityDetailComponent);
    component = fixture.componentInstance;
    mockService = TestBed.inject(InsuranceChangesInEquityService) as jasmine.SpyObj<InsuranceChangesInEquityService>;
