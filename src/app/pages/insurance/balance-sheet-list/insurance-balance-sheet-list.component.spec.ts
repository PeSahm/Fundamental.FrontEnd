...
import { of } from 'rxjs';
import { InsuranceBalanceSheetListComponent } from './insurance-balance-sheet-list.component';
...
describe('InsuranceBalanceSheetListComponent', () => {
  let component: InsuranceBalanceSheetListComponent;
  let fixture: ComponentFixture<InsuranceBalanceSheetListComponent>;
  let serviceSpy: jasmine.SpyObj<InsuranceBalanceSheetService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('InsuranceBalanceSheetService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: InsuranceBalanceSheetService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(InsuranceBalanceSheetListComponent);
