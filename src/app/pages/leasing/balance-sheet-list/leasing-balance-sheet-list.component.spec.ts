...
import { of } from 'rxjs';
import { LeasingBalanceSheetListComponent } from './leasing-balance-sheet-list.component';
...
describe('LeasingBalanceSheetListComponent', () => {
  let component: LeasingBalanceSheetListComponent;
  let fixture: ComponentFixture<LeasingBalanceSheetListComponent>;
  let serviceSpy: jasmine.SpyObj<LeasingBalanceSheetService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('LeasingBalanceSheetService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: LeasingBalanceSheetService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(LeasingBalanceSheetListComponent);
