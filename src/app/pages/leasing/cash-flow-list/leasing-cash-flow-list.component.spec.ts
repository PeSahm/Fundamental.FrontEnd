...
import { of } from 'rxjs';
import { LeasingCashFlowListComponent } from './leasing-cash-flow-list.component';
import { LeasingCashFlowService } from 'src/app/services/leasing-cash-flow.service';
...
describe('LeasingCashFlowListComponent', () => {
  let component: LeasingCashFlowListComponent;
  let fixture: ComponentFixture<LeasingCashFlowListComponent>;
  let serviceSpy: jasmine.SpyObj<LeasingCashFlowService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('LeasingCashFlowService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: LeasingCashFlowService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(LeasingCashFlowListComponent);
