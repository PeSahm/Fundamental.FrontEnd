...
import { of } from 'rxjs';
import { LeasingIncomeStatementListComponent } from './leasing-income-statement-list.component';
import { LeasingIncomeStatementService } from 'src/app/services/leasing-income-statement.service';
...
describe('LeasingIncomeStatementListComponent', () => {
  let component: LeasingIncomeStatementListComponent;
  let fixture: ComponentFixture<LeasingIncomeStatementListComponent>;
  let serviceSpy: jasmine.SpyObj<LeasingIncomeStatementService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('LeasingIncomeStatementService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: LeasingIncomeStatementService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(LeasingIncomeStatementListComponent);
