...
import { LeasingChangesInEquityDetailComponent } from './leasing-changes-in-equity-detail.component';
...
describe('LeasingChangesInEquityDetailComponent', () => {
  let component: LeasingChangesInEquityDetailComponent;
  let fixture: ComponentFixture<LeasingChangesInEquityDetailComponent>;
  let mockService: jasmine.SpyObj<LeasingChangesInEquityService>;
  ...
  beforeEach(async () => {
    const serviceSpy = jasmine.createSpyObj('LeasingChangesInEquityService', ['getById']);
    ...
    await TestBed.configureTestingModule({
      declarations: [LeasingChangesInEquityDetailComponent, PersianNumberPipe, JalaliDatePipe],
      imports: [RouterTestingModule, NgbTooltipModule],
      providers: [
        { provide: LeasingChangesInEquityService, useValue: serviceSpy },
        { provide: ActivatedRoute, useValue: activatedRouteSpy }
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(LeasingChangesInEquityDetailComponent);
    component = fixture.componentInstance;
    mockService = TestBed.inject(LeasingChangesInEquityService) as jasmine.SpyObj<LeasingChangesInEquityService>;
