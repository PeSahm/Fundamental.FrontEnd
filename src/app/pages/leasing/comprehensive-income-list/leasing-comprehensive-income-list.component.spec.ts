...
import { of } from 'rxjs';
import { LeasingComprehensiveIncomeListComponent } from './leasing-comprehensive-income-list.component';
...
describe('LeasingComprehensiveIncomeListComponent', () => {
  let component: LeasingComprehensiveIncomeListComponent;
  let fixture: ComponentFixture<LeasingComprehensiveIncomeListComponent>;
  let serviceSpy: jasmine.SpyObj<LeasingComprehensiveIncomeService>;
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('LeasingComprehensiveIncomeService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: LeasingComprehensiveIncomeService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(LeasingComprehensiveIncomeListComponent);
