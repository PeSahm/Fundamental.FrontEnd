...
describe('ServicesIndustryComprehensiveIncomeListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<ServicesIndustryComprehensiveIncomeService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'ci-1', symbol: 'وخارزم', isin: 'IRO1KHRZ0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('ServicesIndustryComprehensiveIncomeService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: ServicesIndustryComprehensiveIncomeService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'ci-1', symbol: 'وخارزم', isin: 'IRO1KHRZ0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', uri: 'https://codal.ir/1' };
