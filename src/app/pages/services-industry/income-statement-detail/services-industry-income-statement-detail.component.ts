...
@Component({
  ...
  templateUrl: './services-industry-income-statement-detail.component.html',
  styleUrls: ['./services-industry-income-statement-detail.component.scss']
})
export class ServicesIndustryIncomeStatementDetailComponent implements OnInit {
  isLoading = true;
  reportData: any = null;
