...
import { ServicesIndustryChangesInEquityDetailComponent } from './services-industry-changes-in-equity-detail.component';
...
describe('ServicesIndustryChangesInEquityDetailComponent', () => {
  let component: ServicesIndustryChangesInEquityDetailComponent;
  let fixture: ComponentFixture<ServicesIndustryChangesInEquityDetailComponent>;
  let mockService: jasmine.SpyObj<ServicesIndustryChangesInEquityService>;
  ...
  beforeEach(async () => {
    const serviceSpy = jasmine.createSpyObj('ServicesIndustryChangesInEquityService', ['getById']);
    ...
    await TestBed.configureTestingModule({
      declarations: [ServicesIndustryChangesInEquityDetailComponent, PersianNumberPipe, JalaliDatePipe],
      imports: [RouterTestingModule, NgbTooltipModule],
      providers: [
        { provide: ServicesIndustryChangesInEquityService, useValue: serviceSpy },
        { provide: ActivatedRoute, useValue: activatedRouteSpy }
      ]
    }).compileComponents();

    fixture = TestBed.createComponent(ServicesIndustryChangesInEquityDetailComponent);
    component = fixture.componentInstance;
    mockService = TestBed.inject(ServicesIndustryChangesInEquityService) as jasmine.SpyObj<ServicesIndustryChangesInEquityService>;
