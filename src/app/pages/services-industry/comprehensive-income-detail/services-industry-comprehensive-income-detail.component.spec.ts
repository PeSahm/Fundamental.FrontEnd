...
describe('ServicesIndustryComprehensiveIncomeDetailComponent', () => {
  ...
  let mockService: jasmine.SpyObj<ServicesIndustryComprehensiveIncomeService>;
  ...
  beforeEach(async () => {
    const serviceSpy = jasmine.createSpyObj('ServicesIndustryComprehensiveIncomeService', ['getById']);
    ...
    await TestBed.configureTestingModule({
      declarations: [ServicesIndustryComprehensiveIncomeDetailComponent, PersianNumberPipe, JalaliDatePipe],
    ...
    mockService = TestBed.inject(ServicesIndustryComprehensiveIncomeService) as jasmine.SpyObj<ServicesIndustryComprehensiveIncomeService>;
