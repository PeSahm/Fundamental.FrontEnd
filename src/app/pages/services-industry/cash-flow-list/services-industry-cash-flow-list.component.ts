...
export class ServicesIndustryCashFlowListComponent implements OnInit, OnDestroy {
  ...
  constructor(private service: ServicesIndustryCashFlowService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/services-industry/cash-flow', rowItem.id]); } }
