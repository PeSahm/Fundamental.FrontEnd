...
@Component({
  selector: 'app-services-industry-monthly-activity-list',
  templateUrl: './services-industry-monthly-activity-list.component.html',
  styleUrls: ['./services-industry-monthly-activity-list.component.scss']
})
export class ServicesIndustryMonthlyActivityListComponent implements OnInit, OnDestroy {
  selectedItems: any = [];
  ...
  constructor(private service: ServicesIndustryMonthlyActivityService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/services-industry/monthly-activity', rowItem.id]); } }
