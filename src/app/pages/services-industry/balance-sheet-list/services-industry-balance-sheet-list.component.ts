...
export class ServicesIndustryBalanceSheetListComponent implements OnInit, OnDestroy {
  ...
  constructor(private service: ServicesIndustryBalanceSheetService, private router: Router) { }
  ...
  openViewPage(rowItem: any) { if (rowItem?.id) { this.router.navigate(['/services-industry/balance-sheet', rowItem.id]); } }
