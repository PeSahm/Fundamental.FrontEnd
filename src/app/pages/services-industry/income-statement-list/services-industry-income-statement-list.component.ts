...
@Component({
  ...
  templateUrl: './services-industry-income-statement-list.component.html',
  styleUrls: ['./services-industry-income-statement-list.component.scss']
})
export class ServicesIndustryIncomeStatementListComponent implements OnInit, OnDestroy {
  selectedItems: any = [];
