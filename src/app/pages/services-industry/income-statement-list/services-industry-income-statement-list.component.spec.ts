...
describe('ServicesIndustryIncomeStatementListComponent', () => {
  ...
  let serviceSpy: jasmine.SpyObj<ServicesIndustryIncomeStatementService>;

  const mockListResponse = {
    data: {
      items: [
        { id: 'is-1', symbol: 'وخارزم', isin: 'IRO1KHRZ0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 6, uri: 'https://codal.ir/1' }
      ],
      meta: { total: 1 }
    }
  };
  ...
  beforeEach(async () => {
    serviceSpy = jasmine.createSpyObj('ServicesIndustryIncomeStatementService', ['getAll', 'getById']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: ServicesIndustryIncomeStatementService, useValue: serviceSpy },
        provideNgxMask(),
      ]
    }).compileComponents();
  ...
  it('getDetailRow should call getById and set children when expanding', () => {
    const fakeRow = { id: 'is-1', symbol: 'وخارزم', isin: 'IRO1KHRZ0001', fiscalYear: 1402, reportMonth: 6, publishDate: '1402/07/01', version: 6, uri: 'https://codal.ir/1' };
